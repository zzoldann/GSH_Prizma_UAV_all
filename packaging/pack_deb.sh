#!/usr/bin/env bash
set -euo pipefail
which fpm >/dev/null || { echo "Install fpm: sudo apt install ruby-dev build-essential && sudo gem install --no-document fpm"; exit 1; }
